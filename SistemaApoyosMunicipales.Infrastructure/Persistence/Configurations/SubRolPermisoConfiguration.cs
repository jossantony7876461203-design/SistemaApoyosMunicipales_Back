...
namespace SistemaApoyosMunicipales.Infrastructure.Persistence.Configurations
{
    public class SubRolPermisoConfiguration : IEntityTypeConfiguration<SubRolPermiso>
    {
        public void Configure(EntityTypeBuilder<SubRolPermiso> builder)
        {
            ...
            builder.Property(sp => sp.SubRolId)
                .HasColumnName("sub_rol_id");

            builder.Property(sp => sp.PermisoId)
                .HasColumnName("permiso_id");

            builder.Property(sp => sp.PuedeCrear)
                .HasColumnName("puede_crear")
                .HasDefaultValue(false);

            builder.Property(sp => sp.PuedeLeer)
                .HasColumnName("puede_leer")
                .HasDefaultValue(true);

            builder.Property(sp => sp.PuedeEditar)
                .HasColumnName("puede_editar")
                .HasDefaultValue(false);

            builder.Property(sp => sp.PuedeEliminar)
                .HasColumnName("puede_eliminar")
                .HasDefaultValue(false);

            builder.Property(sp => sp.AsignadoAt)
            ...
            builder.HasOne(sp => sp.Permiso)
                .WithMany(p => p.SubRolesPermisos)  // ✅ apunta a la colección
